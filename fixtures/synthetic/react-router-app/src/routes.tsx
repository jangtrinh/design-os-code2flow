...
export function Settings() { const [params] = useSearchParams(); const tab = params.get("tab"); const tabs = ["profile", "billing"]; return <>{tabs.includes(tab ?? "profile") && <p>tab</p>}{tab === "billing" && <p>billing</p>}</>; }
